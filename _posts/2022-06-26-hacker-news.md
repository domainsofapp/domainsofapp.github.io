...
Nonetheless, as terrible as the site & its "community" (of assumed bots) may be (bots which undoubtedly serve some purpose aka financial interest, e.g., to promote the SV Theil/K0ch dynasty/ideals), it's still useful for searching for information, similar to Google Search & Reddit, as long as you are capable of interpreting the information using sound information literacy (skills which do not come easy & take multiple dozens of years to cultivate). So, as w/ most things in life, not True, but still useful...